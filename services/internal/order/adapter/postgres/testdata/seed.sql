-- Сид до goose-миграций: колонки stock здесь ещё нет, остатки проставит 00002.
...
INSERT INTO product (id, uuid, title, price, quality, created_at, description, is_published, is_deleted, slug, category_id) VALUES
    ...
    (3, '33333333-3333-3333-3333-333333333333', 'Old Shoe', '5.00',  2, now(), NULL,   true,  false, 'old-shoe', 2),
