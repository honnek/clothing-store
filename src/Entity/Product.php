...
#[ApiResource(
    operations: [
        ...
        new Patch(normalizationContext: ['groups' => ['product:item:write']], security: "is_granted('ROLE_ADMIN')" ),
    ],
    formats: [ 'jsonld', 'json'],
    order: ['id' => 'DESC'],
...
class Product
{
    ...
    #[Groups(['product:list', 'product:item', 'product:list:write', 'product:item:write', "order:item", "cart:item", "cart:list", "cart_product:item", "cart_product:list"])]
